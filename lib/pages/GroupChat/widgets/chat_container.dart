                      ...
                      child: Align(
                        ...
                        child: SizedBox(
                          ...
                          child: ClipRRect(
                            ...
                            child: profileImage(profilePicture ?? ""),
                          ),
                        ),
                      ),
                    ),
              ...
              child: Column(
                ...
                children: [
                  showInfo
                      ...
                      : const SizedBox(),
                  showInfo ? Text(" ${msg.userName}") : const SizedBox(),
                  msg.isForwarded
                      ? Row(
                          mainAxisAlignment: user == 0
                    ...
                    children: [
                      ...
                      ClipRRect(
                        borderRadius: BorderRadius.only(
                            ...
                            topLeft: Radius.circular(showInfo ? 0 : 17),
    ...
    loadStateChanged: (ExtendedImageState state) {
      switch (state.extendedImageLoadState) {
        case LoadState.loading:
          return Center(
              child: SvgPicture.asset("assets/app/userPlaceholder.svg"));
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: GestureDetector(
          ...
          child: imageMessage(context, imageUrl),
        ),
      );
    },
  );
...
imageMessage(context, snapshotData, {double? height, int user = 0}) {
  try {
    return ExtendedImage.network(
      snapshotData,
      fit: BoxFit.cover,
